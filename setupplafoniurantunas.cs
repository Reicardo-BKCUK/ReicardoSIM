...
namespace Project1
{
    public partial class setupplafoniurantunas : System.Windows.Forms.Form
    {

        public setupplafoniurantunas()
        {
            vb6Globals.setupplafoniurantunas = this;
            InitializeComponent();
        }
        ...
        private void Command1_Click(System.Object _sender, System.EventArgs _e1) 
        {
            ...
            else
            {
                ...
                Adodc1.Recordset.Fields["plafontunas1"].Value = Text2.Text;
                Adodc1.Recordset.Fields["plafontunas2"].Value = Text3.Text;
                Adodc1.Recordset.Fields["plafontunas3"].Value = Text4.Text;
                Adodc1.Recordset.Fields["plafontunas4"].Value = Text5.Text;
        ...
        private void tampil() 
        {
            ...
            Text2.Text = Adodc1.Recordset.Fields["plafontunas1"].Value;
            Text3.Text = Adodc1.Recordset.Fields["plafontunas2"].Value;
            Text4.Text = Adodc1.Recordset.Fields["plafontunas3"].Value;
            Text5.Text = Adodc1.Recordset.Fields["plafontunas4"].Value;
        }
